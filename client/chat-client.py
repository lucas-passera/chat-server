    ...
    def __init__(self):
        ...
        while True:
            ...
            if response.status_code == 200:
                ...
                if MenuManager.check_password_hash(in_password, self.password):    #Compare in password with saved password in db
                    print()
...
#--------------------------------------------------------------------------------------------------------------------    
    def send_message(self, ws):
        while True:
            ...
            if msg.lower() == "./menu":
                menu_manager_instance.handle_chat_menu(url, ws)        
            else:
